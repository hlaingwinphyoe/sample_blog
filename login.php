                ...
                <div class="card border-0">
                    <div class="card-body">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary" name="login-btn"><i class="feather-log-in mr-2"></i>Sign In</button>
                                <a href="register.php" class="btn btn-link">Don't have an account? Click Here:</a>
                            </div>
                        </form>
                    </div>
                </div>
