        ...
        <div class="col-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card mb-4 status-card" onclick="go('<?php echo $url; ?>/post_list.php')">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-3">
                            <i class="feather-database h1 text-primary"></i>
                        </div>
                        <div class="col-9">
                            <p class="mb-1 h4 font-weight-bolder">
                    ...
                    <div class="d-flex justify-content-between align-items-center p-3">
                        ...
                        <div class="">
                            <?php
                                ...
                                $currentUserPostTotal = countTotal("posts","user_id=$userId");
                            ...
                            <div class="progress progress-bar-animated" style="width: 280px;height: 8px">
